...
class BinarySearchTree {
  ...
  deleteNode(root, value) {
    ...
    if (value < root.value) {
      ...
      root.value = this.min(root.right); // in case root have both the child nodes // in this case we copy the value of inorder successor
      // and then delet the inorder succesor of that node // inorder successor is the min value of the right node
